...
public class RejectedChemicalLot extends LoginDetails {
	...
	public void chemicalLotRejected() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RejectedChemicalLot"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Chemical Lot Rejected", "LIMS-CM-007", "Pass");
