				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (arNumber.equalsIgnoreCase(arNumberSequence)) {
							// driver.findElement(By.xpath("//*[@id=\"selectChkBoxInMyJobsGrid11\"]/div/table/tbody/tr[
							// " + i + " ]")).click();
							// *//*[@id="myJobListTable"]/div/table/tbody/tr[2]/td[3]
							// *[@id="selectChkBoxInMyJobsGrid59"]
							driver.findElement(By.xpath("//*[@id=\"myJobListTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]/input")).click();
							// driver.findElement(By.xpath("//*[starts-with(@id,
							// \"selectChkBoxInMyJobsGrid\")]/div/table/tbody/tr[ " + i + " ]")).click();
					...
					if (arNumber.equalsIgnoreCase(arNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"myJobListTable\"]/div/table/tbody/tr/td[3]/input")).click();
						isRecordSelected = true;
						break;
					}
				}
