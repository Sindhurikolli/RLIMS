...
public class ModifySpecificationApproval extends SMLoginDetails {
	...
	private void methodToapproveSpecification() throws Exception {
		...
		WebElement element1 = driver.findElement(By.id("specAppPageInSample"));
		...
		String storageCondition = properties.getProperty("Supplier_Name_50");
...
//				Thread.sleep(3000);
			driver.findElement(By.id("commentsInViewSpecApp")).sendKeys(properties.getProperty("comments_200"));
			Thread.sleep(2000);
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#specRegDetailsTableInSpecApproval > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
