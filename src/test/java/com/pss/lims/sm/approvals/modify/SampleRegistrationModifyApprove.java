...
public class SampleRegistrationModifyApprove extends SMLoginDetails {
	...
	private void methodToapproveSampleRegistration() throws Exception {
		...
		WebElement element1 = driver.findElement(By.id("sampleRegAppPageInSample"));
...
//				Thread.sleep(3000);
			driver.findElement(By.id("commentsInViewSampAppGrid")).sendKeys(properties.getProperty("Description_200"));
			Thread.sleep(2000);
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (storageCondition.contains(DevNumberSequence)) {
							driver.findElement(By.xpath("//*[@id=\"renderSampRegAppInAppBtn\"]/div/table/tbody/tr[ " + i
									+ " ]/td[" + i + "]/button")).click();
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#limsSampleRegApprovalJtable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
