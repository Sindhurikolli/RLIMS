...
public class SampleRegistration extends SMLoginDetails {
	...
	public void modifySampleRegistration() throws Exception {
		...
		Thread.sleep(3000);
		methodFormodifySampleRegistration();

	}

	private void methodFormodifySampleRegistration() throws Exception {
		...
		WebElement element11 = driver.findElement(By.id("sampleRegModifyInAuditForm"));
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (product.contains(DevNumberSequence)) {
							driver.findElement(By.id("renderViewLimsUomModifyAuditDetails")).click();
