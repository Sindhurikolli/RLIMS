...
//		Thread.sleep(3000);
	...
	private void methodForProdut() throws Exception {
		...
		WebElement element11 = driver.findElement(By.id("productStatusChangeAuditTrialsForm"));
		jse11.executeScript("arguments[0].scrollIntoView(true);", element1);
		Thread.sleep(2000);
		jse11.executeScript("arguments[0].click();", element11);
		Thread.sleep(3000);
		driver.findElement(By.id("searchBtnInProdStatusChangeAudit")).click();
		Thread.sleep(3000);
		int count1 = 0;
		...
		if (isRecordSelected1) {
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id=\"closeBtnInViewProductStsChngAuditForm\"]/span")).click();
			Thread.sleep(3000);
		} else {
	...
	private boolean selectRecordForProduct(int count1, boolean isRecordSelected1, String product) throws Exception {
		...
		WebElement table = driver.findElement(By.id("productStsChngAuditGrid"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"productStsChngAuditGrid\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//								System.out.println("hi this is ravi");
				product = driver
						.findElement(By.xpath("//*[@id=\"productStsChngAuditGrid\"]/div/table/tbody/tr[1]/td[2]"))
						.getText();// documentType
			} else if ((product == null) || ("".equalsIgnoreCase(product))) {
				product = driver.findElement(By.xpath("//*[@id=\"productStsChngAuditGrid\"]/div/table/tbody/tr/td[2]"))
						.getText();// document
									// type
			}
			++count1;
					...
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver
								.findElement(By.xpath(
										"//*[@id=\"productStsChngAuditGrid\"]/div/table/tbody/tr[ " + i + " ]/td[2]"))
								.getText();// documentTypeName
						if (product.contains(DevNumberSequence)) {
							driver.findElement(By.xpath("//*[@id=\"productStsChngAuditGrid\"]/div/table/tbody/tr[ " + i
									+ " ]/td[8]/button")).click();
...
////											Thread.sleep(2000);
					...
					String DevNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"productStsChngAuditGrid\"]/div/table/tbody/tr/td[2]"))
							.getText();
					if (product.contains(DevNumberSequence)) {
						driver.findElement(
								By.xpath("//*[@id=\"productStsChngAuditGrid\"]/div/table/tbody/tr/td[8]/button"))
								.click();
//										JavascriptExecutor jse11 = (JavascriptExecutor) driver;
...
////										Thread.sleep(2000);
				...
				if ((!isRecordSelected1) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#productStsChngAuditGrid > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("productStsChngAuditGrid"));// Document
					// Tree
					// approve
					// table
