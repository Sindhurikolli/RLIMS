...
public class Product extends SMLoginDetails {
	...
	public void modifyProduct() throws Exception {
		...
		Thread.sleep(3000);
		methodFormodifyProduct();

	}

	private void methodFormodifyProduct() throws Exception {
		...
		WebElement element11 = driver.findElement(By.id("productModifyInAuditForm"));
		jse11.executeScript("arguments[0].scrollIntoView(true);", element1);
		Thread.sleep(2000);
		jse11.executeScript("arguments[0].click();", element11);
		Thread.sleep(3000);
		driver.findElement(By.id("searchBtnInProductModifyAuditForm")).click();
		Thread.sleep(3000);
		int count1 = 0;
		boolean isRecordSelected1 = false;
		String product = properties.getProperty("StageName_30");
...
//			driver.findElement(By.id("cancelBtnInDialogForProductDetails")).click();
			...
			WebElement element111 = driver.findElement(By.id("cancelBtnInDialogForProductDetails"));
			jse111.executeScript("arguments[0].click();", element111);
			Thread.sleep(3000);
//			driver.findElement(By.id("saveAsExcelBtnInProductModifyAuditForm")).click();
			JavascriptExecutor jse1111 = (JavascriptExecutor) driver;
			WebElement element1111 = driver.findElement(By.id("saveAsExcelBtnInProductModifyAuditForm"));
	...
	private boolean selectRecordForProduct(int count1, boolean isRecordSelected1, String product) throws Exception {
		...
		WebElement table = driver.findElement(By.id("productDetailsTabInProductModifyAuditForm"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(
							By.xpath("//*[@id=\"productDetailsTabInProductModifyAuditForm\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//								System.out.println("hi this is ravi");
				product = driver
						.findElement(By.xpath(
								"//*[@id=\"productDetailsTabInProductModifyAuditForm\"]/div/table/tbody/tr[1]/td[4]"))
						.getText();// documentType
			} else if ((product == null) || ("".equalsIgnoreCase(product))) {
				product = driver
						.findElement(By.xpath(
								"//*[@id=\"productDetailsTabInProductModifyAuditForm\"]/div/table/tbody/tr/td[4]"))
						.getText();// document
									// type
			}
			++count1;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(
								By.xpath("//*[@id=\"productDetailsTabInProductModifyAuditForm\"]/div/table/tbody/tr[ "
										+ i + " ]/td[4]"))
								.getText();// documentTypeName
						if (product.contains(DevNumberSequence)) {
							driver.findElement(By
									.xpath("//*[@id=\"productDetailsTabInProductModifyAuditForm\"]/div/table/tbody/tr[ "
											+ i + " ]/td[13]/button"))
									.click();
...
////											Thread.sleep(2000);
					...
					if (product.contains(DevNumberSequence)) {
						driver.findElement(By.xpath(
								"//*[@id=\"productDetailsTabInProductModifyAuditForm\"]/div/table/tbody/tr/td[13]/button"))
								.click();
//										JavascriptExecutor jse11 = (JavascriptExecutor) driver;
...
////										Thread.sleep(2000);
				...
				if ((!isRecordSelected1) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#productDetailsTabInProductModifyAuditForm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("productDetailsTabInProductModifyAuditForm"));// Document
					// Tree
					// approve
					// table
