...
public class StroageCondition extends SMLoginDetails {
	...
	private void methodTocreateStorageCondition() throws Exception {
		...
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Create Storage Condition Radio Button", sno, false);
		Thread.sleep(3000);
