...
public class CreateRole extends SMLoginDetails {
	@Test
	public void createRole() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CreateRole", "LIMS-SM-002", "Pass");
	...
	private void createRoleMethod() throws Exception {
		...
		sno++;
		driver.findElement(By.cssSelector("a[href='createRolePageInSample.do'")).click();
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Role", sno, false);
		Thread.sleep(3000);
		sno++;
		driver.findElement(By.id("createLimsRoleAction")).click();
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Creation of Role", sno, false);
		Thread.sleep(3000);
		sno++;
		...
		Thread.sleep(5000);
		sno++;
		driver.findElement(By.id("createLimsRoleName")).sendKeys(properties.getProperty("Role_Name"));
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Role Name", sno, false);
		Thread.sleep(2000);
		sno++;
		driver.findElement(By.id("createLimsRoleDescription")).sendKeys(properties.getProperty("Role_Description"));
