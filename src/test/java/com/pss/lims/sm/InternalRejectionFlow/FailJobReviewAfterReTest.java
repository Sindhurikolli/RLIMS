			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						js0.executeScript("arguments[0].scrollIntoView();", imLinkText);
						Thread.sleep(1000);
						String arNumberSequence = driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).getText();// documentTypeName
						if (arNumber.equalsIgnoreCase(arNumberSequence)) {
					...
					JavascriptExecutor js0 = (JavascriptExecutor)driver;
					WebElement imLinkText = driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[4]"));
					js0.executeScript("arguments[0].scrollIntoView();", imLinkText);
					Thread.sleep(1000);
					String arNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[4]"))
