...
public class FailJobReviewDescreetValues extends SMLoginDetails {

	@Test
	public void failJobReviewDescreetValues() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "FailJobReviewDescreetValues" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Fail Job Review DescreetValues", "PSS-LIMS-108", "Pass");
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#failedTestGrid > div > div.jtable-busy-message[style='display: none;']")));
		Thread.sleep(2000);
		methodToFailJobReviewDescreetValues();
		document.close();
		writer.close();
	...
	private void methodToFailJobReviewDescreetValues() throws Exception {
...
//		jse1.executeScript("arguments[0].click();", element1);
		...
		if (isRecordSelected) {
			...
			driver.findElement(By.xpath(".//*[@id='modal-window']/div/div/div[3]/a")).click();
				...
				Thread.sleep(3000);
				sno++;
				driver.findElement(By.id("descreetValueskActionOOSRadioBtn")).click();
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Comments", sno,false);
				Thread.sleep(3000);
				
				sno++;
				driver.findElement(By.id("contnueBtnInOOSFailedJobReview")).click();
...
//				
				Thread.sleep(3000);
				sno++;
				Select testStatus = new Select(driver.findElement(By.id("testStatusInQualDescreetVals")));
				testStatus.selectByIndex(1);
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select Test Status ", sno, false);
				Thread.sleep(2000);
				sno++;
				driver.findElement(By.id("variableAnsInQualDesJobResult1")).sendKeys(properties.getProperty("FinalValue"));
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Compliance Value", sno, false);
				Thread.sleep(2000);
				
				sno++;
				driver.findElement(By.id("reasonInQualDescreetVals")).sendKeys(properties.getProperty("Approval_Comments"));
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Comments", sno, false);
				Thread.sleep(2000);
				
				sno++;
				driver.findElement(By.id("submitBtnInQualDescreetValsWin")).click();
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						WebElement imLinkText = driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr[ " + i + " ]/td[4]"));
						js0.executeScript("arguments[0].scrollIntoView();", imLinkText);
						Thread.sleep(1000);
						Thread.sleep(1000);
						String arNumberSequence = driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr[ " + i + " ]/td[4]"))	.getText();
						if (arNumber.equalsIgnoreCase(arNumberSequence)) {
							Thread.sleep(1000);
							driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr[ " + i + " ]/td[19]")).click();
							Thread.sleep(1000);
					...
					String arNumberSequence = driver
							...
							.getText();
					if (arNumber.equalsIgnoreCase(arNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[19]"))
								.click();
						isRecordSelected = true;
						break;
					}
				...
				}//*[@id="failedTestGrid"]/div/table/tbody/tr/td[19]
			}
		}
