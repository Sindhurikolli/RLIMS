...
public class QuantativeJobResultsNonCompliance extends SMLoginDetails {
	...
	private void methodToapproveJobResults() throws Exception {
		...
		if (isRecordSelected) {
			...
			String[] Variables = properties.getProperty("Verify_Value_NonCompliance").split(",");
			for (int i = 1; i <= noofVariables; i++) {
				sno++;
				driver.findElement(By
						.xpath("//*[@id=\"variableGridStoreInJobResult1\"]/div/table/tbody/tr[" + i + "]/td[5]/input")).clear();
				driver.findElement(By
