...
public class FailJobReviewWithReCheck extends SMLoginDetails {
...
//		jse1.executeScript("arguments[0].click();", element1);
		...
		if (isRecordSelected) {
			...
			Thread.sleep(3000);
			sno++;
			driver.findElement(By.id("recheckActionOOSRadioBtn")).click();
	...
	private boolean selectRecordForarNumber(int count, boolean isRecordSelected, String arNumber) throws Exception {
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((arNumber == null) || ("".equalsIgnoreCase(arNumber)))) {
				Helper.scrollElement(driver, By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr[1]/td[4]"));
				arNumber = driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr[1]/td[4]")).getText();// 
			} else if ((arNumber == null) || ("".equalsIgnoreCase(arNumber))) {
				Helper.scrollElement(driver, By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[4]"));
				arNumber = driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[4]")).getText();// document type
			}
			++count;
		}
		if (perPageNoOfRecordsPresent > 0) {
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						Thread.sleep(1000);
						Helper.scrollElement(driver, By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr[" + i + "]/td[4]"));
					...
					Helper.scrollElement(driver, By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[4]"));
					String arNumberSequence = driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[4]")).getText();
					if (arNumber.equalsIgnoreCase(arNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"failedTestGrid\"]/div/table/tbody/tr/td[19]")).click();
						isRecordSelected = true;
						break;
					}
				}
