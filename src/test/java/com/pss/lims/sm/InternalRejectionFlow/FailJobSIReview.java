...
public class FailJobSIReview extends SMLoginDetails {
	...
	public void failJobSIReview() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Fail Job SI Review", "PSS-LIMS-109", "Pass");
	...
	private void methodToFailJobSIReview() throws Exception {
		...
		if (isRecordSelected) {
			...
			WebElement ele = driver.findElement(By.id("submitBtnInlimsSampleInChargeForm"));
