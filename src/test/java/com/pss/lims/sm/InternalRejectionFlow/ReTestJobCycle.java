...
public class ReTestJobCycle extends SMLoginDetails {

	@Test
	public void reTestJobCycle() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ReTestJobCycle" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ReTest Job Cycle", "PSS-LIMS-115", "Pass");
		...
		WebElement element1 = driver.findElement(By.cssSelector("a[href='oosRetestJobCyclePage.do']"));
		jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
		jse1.executeScript("arguments[0].click();", element1);
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "ReTest Job Cycle", sno, false);
		Thread.sleep(4000);
		methodToReTestJobCycle();
		document.close();
		writer.close();
	...
	private void methodToReTestJobCycle() throws Exception {
...
//		Thread.sleep(3000);
		...
		if (isRecordSelected1) {
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select a Record", sno,
					false);
			sno++;
			driver.findElement(By.id("noOfRetestsCycleInRetestJobCycle")).sendKeys(properties.getProperty("No_of_Retest_cycle"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter No of Retest cycle", sno, false);
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("addAnalystInOosJobRetestCycle")).click();
			...
			sno++;
			driver.findElement(By.id("submitBtnInOosJobRetestCycle")).click();
	...
	private boolean selectRecordForarNumber(int count1, boolean isRecordSelected1, String arNumber) throws Exception {
		...
		WebElement table = driver.findElement(By.id("limsRetestJobCycleGrid"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"limsRetestJobCycleGrid\"]/div/div[4]/div[2]/span")).getText();// For
			//*[@id="limsRetestJobCycleGrid"]/div/table/tbody/tr/td[4]
...
//				//*[@id="limsRetestJobCycleGrid"]/div/table/tbody/tr[2]/td[4]
				arNumber = driver.findElement(By.xpath("//*[@id=\"limsRetestJobCycleGrid\"]/div/table/tbody/tr[1]/td[4]"))
						.getText();// documentType//*[@id="limsRetestJobCycleGrid"]/div/table/tbody/tr/td[4]
			} else if ((arNumber == null) || ("".equalsIgnoreCase(arNumber))) {
				arNumber = driver.findElement(By.xpath("//*[@id=\"limsRetestJobCycleGrid\"]/div/table/tbody/tr/td[4]"))
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String arNumberSequence = driver
								.findElement(By
										.xpath("//*[@id=\"limsRetestJobCycleGrid\"]/div/table/tbody/tr[ " + i + " ]/td[4]"))
								.getText();// documentTypeName
						if (arNumber.equalsIgnoreCase(arNumberSequence)) {
							driver.findElement(By.xpath(
									"//*[@id=\"limsRetestJobCycleGrid\"]/div/table/tbody/tr[ " + i + " ]/td[4]"))
									.click();
					...
					String arNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"limsRetestJobCycleGrid\"]/div/table/tbody/tr/td[4]"))
							.getText();
					if (arNumber.equalsIgnoreCase(arNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"limsRetestJobCycleGrid\"]/div/table/tbody/tr/td[4]"))
								.click();
						isRecordSelected1 = true;
						break;
					}
				...
				if ((!isRecordSelected1) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#limsRetestJobCycleGrid > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("limsRetestJobCycleGrid"));// Document Tree approve table
