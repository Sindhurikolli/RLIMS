...
public class FailJobHODReview extends SMLoginDetails {
	...
	public void failJobHODReview() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Fail Job HOD Review", "PSS-LIMS-110", "Pass");
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#oosHodAppGrid > div > div.jtable-busy-message[style='display: none;']")));
		Thread.sleep(2000);
		Thread.sleep(2000);
...
//		Thread.sleep(3000);
		...
		jse209.executeScript("arguments[0].click();", element209);
		 ...
		 Thread.sleep(3000);
			...
			Assert.assertTrue(isRecordSelected, "Record is not Selected");
		}
	}
