...
public class HistoryOfSpecification extends SMLoginDetails {
	...
	public void historyofSpecification() throws Exception {
		...
		Thread.sleep(4000);
		driver.findElement(By.id("historyOfSpecRepForm")).click();
		Thread.sleep(4000);
		methodForspecSheet();
	...
	private void methodForspecSheet() throws Exception {
		...
		driver.findElement(By.id("searchBtnInHistoryOfSpecRepForm")).click();
		Thread.sleep(3000);
		int count = 0;
	...
	private boolean selectRecordForPrint(int count, boolean isRecordSelected, String record) throws Exception {
		...
		WebElement table = driver.findElement(By.id("HistoryOfSpecRecTableInHistoryOfSpecRepForm"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(
							By.xpath("//*[@id=\"HistoryOfSpecRecTableInHistoryOfSpecRepForm\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//						System.out.println("hi this is ravi");
				record = driver
						.findElement(By.xpath(
								"//*[@id=\"HistoryOfSpecRecTableInHistoryOfSpecRepForm\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((record == null) || ("".equalsIgnoreCase(record))) {
				record = driver
						.findElement(By.xpath(
								"//*[@id=\"HistoryOfSpecRecTableInHistoryOfSpecRepForm\"]/div/table/tbody/tr/td[3]"))
						.getText();// document
									// type
			}
			++count;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(
								By.xpath("//*[@id=\"HistoryOfSpecRecTableInHistoryOfSpecRepForm\"]/div/table/tbody/tr[ "
										+ i + " ]/td[3]"))
								.getText();// documentTypeName
						if (record.contains(DevNumberSequence)) {
							driver.findElement(By.xpath(
									"//*[@id=\"HistoryOfSpecRecTableInHistoryOfSpecRepForm\"]/div/table/tbody/tr[ " + i
											+ " ]/td[3]"))
									.click();
...
////									Thread.sleep(2000);
					...
					String DevNumberSequence = driver.findElement(By
							.xpath("//*[@id=\"HistoryOfSpecRecTableInHistoryOfSpecRepForm\"]/div/table/tbody/tr/td[3]"))
							.getText();
					if (record.contains(DevNumberSequence)) {
						driver.findElement(By.xpath(
								"//*[@id=\"HistoryOfSpecRecTableInHistoryOfSpecRepForm\"]/div/table/tbody/tr/td[3]"))
...
////								Thread.sleep(2000);
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#HistoryOfSpecRecTableInHistoryOfSpecRepForm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("HistoryOfSpecRecTableInHistoryOfSpecRepForm"));// Document
					// Tree
					// approve
					// table
