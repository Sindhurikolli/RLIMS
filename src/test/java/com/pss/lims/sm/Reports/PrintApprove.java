...
public class PrintApprove extends SMLoginDetails {

	@Test
	public void approvePrint() throws Exception {
		...
		Thread.sleep(4000);
		driver.findElement(By.id("cOAPrintApproveForm")).click();
		Thread.sleep(4000);
		methodToApprovePrint();

	}

	private void methodToApprovePrint() throws Exception {
		...
		if (isRecordSelected) {
			Thread.sleep(5000);
			driver.findElement(By.id("ApprBtnInCOAPrntAppFrm")).click();
			Thread.sleep(3000);
	...
	private boolean selectRecordForPrint(int count, boolean isRecordSelected, String record) throws Exception {
		...
		WebElement table = driver.findElement(By.id("COAPrintAppGrid"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"COAPrintAppGrid\"]/div/div[4]/div[2]/span")).getText();// For
			// Ex:
			// Showing
			// 1-1
			// of
...
//						System.out.println("hi this is ravi");
				record = driver
						.findElement(
								By.xpath("//*[@id=\"COAPrintAppGrid\"]/div/table/tbody/tr[1]/td[5]"))
						.getText();// documentType
			} else if ((record == null) || ("".equalsIgnoreCase(record))) {
				record = driver
						.findElement(By.xpath("//*[@id=\"COAPrintAppGrid\"]/div/table/tbody/tr/td[5]"))
						.getText();// document
									// type
			}
			++count;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(By.xpath(
								"//*[@id=\"COAPrintAppGrid\"]/div/table/tbody/tr[ " + i + " ]/td[5]"))
								.getText();// documentTypeName
						if (record.contains(DevNumberSequence)) {
							driver.findElement(
									By.xpath("//*[@id=\"COAPrintAppGrid\"]/div/table/tbody/tr[ " + i
											+ " ]/td[5]"))
									.click();
...
////									Thread.sleep(2000);
					...
					String DevNumberSequence = driver
							.findElement(
									By.xpath("//*[@id=\"COAPrintAppGrid\"]/div/table/tbody/tr/td[5]"))
							.getText();
					if (record.contains(DevNumberSequence)) {
						driver.findElement(
								By.xpath("//*[@id=\"COAPrintAppGrid\"]/div/table/tbody/tr/td[5]"))
...
////								Thread.sleep(2000);
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#COAPrintAppGrid > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("COAPrintAppGrid"));// Document
																			// Tree
																			// approve
					// table
