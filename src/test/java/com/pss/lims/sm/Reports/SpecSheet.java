...
public class SpecSheet extends SMLoginDetails {

	@Test
	public void specSheet() throws Exception {
		...
		Thread.sleep(4000);
		driver.findElement(By.id("SpecSheetReportsForm")).click();
		Thread.sleep(4000);
		methodForspecSheet();
	...
	private void methodForspecSheet() throws Exception {
		...
		driver.findElement(By.id("searchBtnInSpecSheet")).click();
		Thread.sleep(3000);
		int count = 0;
		...
		if (isRecordSelected) {
			Thread.sleep(3000);
			driver.findElement(By.id("viewReportBtnInSpecSheet")).click();
			Thread.sleep(10000);
	...
	private boolean selectRecordForPrint(int count, boolean isRecordSelected, String record) throws Exception {
		...
		WebElement table = driver.findElement(By.id("specSheetJtable"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"specSheetJtable\"]/div/div[4]/div[2]/span")).getText();// For
			// Ex:
			// Showing
			// 1-1
			// of
...
//						System.out.println("hi this is ravi");
				record = driver.findElement(By.xpath("//*[@id=\"specSheetJtable\"]/div/table/tbody/tr[1]/td[4]"))
						.getText();// documentType
			} else if ((record == null) || ("".equalsIgnoreCase(record))) {
				record = driver.findElement(By.xpath("//*[@id=\"specSheetJtable\"]/div/table/tbody/tr/td[4]"))
						.getText();// document
									// type
			}
			++count;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver
								.findElement(
										By.xpath("//*[@id=\"specSheetJtable\"]/div/table/tbody/tr[ " + i + " ]/td[4]"))
...
////									Thread.sleep(2000);
					...
					String DevNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"specSheetJtable\"]/div/table/tbody/tr/td[4]")).getText();
					if (record.contains(DevNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"specSheetJtable\"]/div/table/tbody/tr/td[4]")).click();
...
////								Thread.sleep(2000);
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#specSheetJtable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("specSheetJtable"));// Document
					// Tree
					// approve
					// table
