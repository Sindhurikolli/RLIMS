...
public class TestPlannerHold extends SMLoginDetails {

	@Test
	public void holdTestPlanner() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "HoldTestPlanner" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Hold Test Planner", "LIMS-SM-024", "Pass");
	...
	private void methodToHoldTestPlanner() throws Exception {
		...
		sno++;
		driver.findElement(By.id("selProductBtnInUnholdTest")).click();
		...
		if (isRecordSelected1) {
			...
			Thread.sleep(3000);
			sno++;
			Select spec = new Select(driver.findElement(By.id("specificationInHoldTestPlannerStatusChngForm")));
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("selAppByBtnInHoldTestPlannerStatusChngForm")).click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Select", sno, false);
			Thread.sleep(5000);
			sno++;
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("commentsInHoldTestPlannerStatusChngForm"))
					.sendKeys(properties.getProperty("Stage_Name"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Comments", sno, false);
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("submitBtnInTestPlnrStatusChangeForm")).click();
