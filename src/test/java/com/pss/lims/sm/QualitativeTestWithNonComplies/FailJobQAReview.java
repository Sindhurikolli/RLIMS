...
public class FailJobQAReview extends SMLoginDetails {
	...
	public void failJobQAReview() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Fail Job QA Review", "LIMS-SM-111", "Pass");
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='oosQAReviewPageInSample.do'")));
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(
				By.cssSelector("#oosQaAppGrid > div > div.jtable-busy-message[style='display: none;']")));
		Thread.sleep(4000);
...
//				//*[@id="oosQaAppGrid"]/div/table/tbody/tr[2]/td[4]
				...
				arNumber = driver.findElement(By.xpath("//*[@id=\"oosQaAppGrid\"]/div/table/tbody/tr/td[4]")).getText();// document
																														// type
			}
			++count;
		}
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String arNumberSequence = driver
								.findElement(
										By.xpath("//*[@id=\"oosQaAppGrid\"]/div/table/tbody/tr[ " + i + " ]/td[4]"))
					...
					String arNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"oosQaAppGrid\"]/div/table/tbody/tr/td[4]")).getText();
					if (arNumber.equalsIgnoreCase(arNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"oosQaAppGrid\"]/div/table/tbody/tr/td[4]")).click();
						isRecordSelected = true;
						break;
					}
				}
