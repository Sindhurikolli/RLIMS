...
public class JobResultsQualitativeTestNonCompliance extends SMLoginDetails {
	...
	public void rejectJobResults() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "JobResultsNonCompliance"
...
//				System.out.println("hi this is ravi");
				arNumber = driver.findElement(By.xpath("//*[@id=\"jobResultsJTable\"]/div/table/tbody/tr[1]/td[6]"))
						.getText();// *[@id="jobResultsJTable"]/div/table/tbody/tr[1]/td[6]
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
					...
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (arNumber.contains(arNumberSequence)) {
							driver.findElement(By.xpath(
									"//*[starts-with(@id, \"jobResultsJTable\")]/div/table/tbody/tr[ " + i + " ]"))
									.click();
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#jobResultsJTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
