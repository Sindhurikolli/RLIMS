...
public class Customer extends SMLoginDetails {
	...
	public void manufacturer() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.id("limsCustomerAuditForm")).click();
		Thread.sleep(3000);
	...
	private void methodFormanufacturer() throws Exception {
		...
		driver.findElement(By.id("searchBtnInCustomerAuditFrmSrch")).click();
		Thread.sleep(3000);
		int count1 = 0;
	...
	private boolean selectRecordForProduct(int count1, boolean isRecordSelected1, String product) throws Exception {
		...
		WebElement table = driver.findElement(By.id("customerDetailsGridInCustomerAuditFrm"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(By.xpath("//*[@id=\"customerDetailsGridInCustomerAuditFrm\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//							System.out.println("hi this is ravi");
				product = driver.findElement(By.xpath(
						"//*[@id=\"customerDetailsGridInCustomerAuditFrm\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((product == null) || ("".equalsIgnoreCase(product))) {
				product = driver.findElement(By.xpath(
						"//*[@id=\"customerDetailsGridInCustomerAuditFrm\"]/div/table/tbody/tr/td[3]"))
						.getText();// document
									// type
			}
			++count1;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(By.xpath(
								"//*[@id=\"customerDetailsGridInCustomerAuditFrm\"]/div/table/tbody/tr[ "
										+ i + " ]/td[3]"))
...
////									Thread.sleep(2000);
				...
				if ((!isRecordSelected1) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#customerDetailsGridInCustomerAuditFrm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("customerDetailsGridInCustomerAuditFrm"));// Document
					// Tree
					// approve
					// table
