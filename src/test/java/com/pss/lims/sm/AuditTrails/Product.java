...
public class Product extends SMLoginDetails {
	...
	public void product() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.id("productInAuditForm")).click();
		Thread.sleep(3000);
		methodForproduct();

	}

	private void methodForproduct() throws Exception {

		driver.findElement(By.id("searchBtnInProductAuditForm")).click();
		Thread.sleep(3000);
		int count1 = 0;
		...
		if (isRecordSelected1) {
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id=\"cancelBtnInDialogForProductDetails\"]/span")).click();
			Thread.sleep(3000);
			driver.findElement(By.id("saveAsExcelBtnInProductStatusAuditForm")).click();
			Thread.sleep(6000);
...
//			Thread.sleep(3000);
	...
	private boolean selectRecordForProduct(int count1, boolean isRecordSelected1, String product) throws Exception {
		...
		WebElement table = driver.findElement(By.id("productDetailsTabInProductAuditForm"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(By.xpath("//*[@id=\"productDetailsTabInProductAuditForm\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//				System.out.println("hi this is ravi");
				product = driver
						.findElement(By
								.xpath("//*[@id=\"productDetailsTabInProductAuditForm\"]/div/table/tbody/tr[1]/td[2]"))
						.getText();// documentType
			} else if ((product == null) || ("".equalsIgnoreCase(product))) {
				product = driver
						.findElement(
								By.xpath("//*[@id=\"productDetailsTabInProductAuditForm\"]/div/table/tbody/tr/td[2]"))
						.getText();// document
									// type
			}
			++count1;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(
								By.xpath("//*[@id=\"productDetailsTabInProductAuditForm\"]/div/table/tbody/tr[ " + i
										+ " ]/td[2]"))
...
////							Thread.sleep(2000);
					...
					String DevNumberSequence = driver
							.findElement(By
									.xpath("//*[@id=\"productDetailsTabInProductAuditForm\"]/div/table/tbody/tr/td[2]"))
							.getText();
					if (product.contains(DevNumberSequence)) {
						driver.findElement(By.xpath(
								"//*[@id=\"productDetailsTabInProductAuditForm\"]/div/table/tbody/tr/td[5]/button"))
								.click();
...
////						Thread.sleep(2000);
				...
				if ((!isRecordSelected1) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#productDetailsTabInProductAuditForm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("productDetailsTabInProductAuditForm"));// Document
																								// Tree
																								// approve
					// table
