...
public class RMSampleQuantityRegistration extends SMLoginDetails {
...
//			Thread.sleep(2000);
			sno++;
			Select scuserselect = new Select(driver.findElement(By.id("sampColJobOwnerInSampleQuantViewForm")));
			Thread.sleep(2000);
			scuserselect.selectByVisibleText(properties.getProperty("RMCHECKPrintUser"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select Sample Collection User", sno, false);
			Thread.sleep(2000);
			sno++;
