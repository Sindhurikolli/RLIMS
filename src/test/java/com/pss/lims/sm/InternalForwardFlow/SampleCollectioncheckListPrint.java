...
public class SampleCollectioncheckListPrint extends SMLoginDetails {
	...
	public void approveSI() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "SampleCollectioncheckListPrint" + (new Random().nextInt())
				+ ".pdf";
