...
public class RMSpecificationApproval extends RegistrationDetails {
...
//		module.selectByVisibleText(properties.getProperty("Lims_Module_Name1"));
	...
	private void methodToApproveSpecification() throws Exception {
		...
		String specification = properties.getProperty("RMSpec_No");
...
//				System.out.println("hi this is ravi");
				specification = driver
						.findElement(
								By.xpath("//*[@id=\"qmsSpecificationRegApprovalGrid\"]/div/table/tbody/tr/td[3]"))
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String specificationSequence = driver.findElement(By.xpath(
								"//*[@id=\"qmsSpecificationRegApprovalGrid\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
