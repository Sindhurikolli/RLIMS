...
public class TestPlannerReject extends RegistrationLoginDetails {
	...
	public void approveTestPlanner() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RejectTestPlanner" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Reject Test Planner", "LIMS-SM-069", "Pass");
	...
	private void methodToRejectTestPlanner() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("rejectBtnInTestPlanApproval")).click();
