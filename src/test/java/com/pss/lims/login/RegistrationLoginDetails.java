...
//	private static String loginUserPassword = System.getProperty("userpassword");
	...
	public void setUp() throws Exception {
	    ...
	    propertyFilePathName = propertiesFilePath; 	
			...
			propertyFilePathName ="src/test/java/LIMSUIProperties/Registration.properties";	
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("Registration.properties not found at " + propertyFilePath);
		}
