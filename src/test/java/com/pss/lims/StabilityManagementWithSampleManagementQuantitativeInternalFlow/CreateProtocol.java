		...
		if (isRecordSelected1) {
			...
			for (int i = 1; i <= noofBatches; i++) {
				...
				driver.findElement(By.xpath(
						"//*[@id=\"batchesInProtocolEditorTable\"]/div/table/tbody/tr[" + i + "]/td[2]/textarea"))
						.sendKeys("44");
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Batch No", sno, false);
				Thread.sleep(2000);
				sno++;
				driver.findElement(By.xpath(
						"//*[@id=\"batchesInProtocolEditorTable\"]/div/table/tbody/tr[" + i + "]/td[3]/textarea"))
						.sendKeys("02-11-2020");
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Manufacturing Date", sno,
						false);
				Thread.sleep(2000);
				sno++;
				driver.findElement(By.xpath(
						"//*[@id=\"batchesInProtocolEditorTable\"]/div/table/tbody/tr[" + i + "]/td[4]/textarea"))
						.sendKeys("02-11-2024");
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Expiry Date", sno, false);
				Thread.sleep(2000);
				sno++;
				driver.findElement(By.xpath(
						"//*[@id=\"batchesInProtocolEditorTable\"]/div/table/tbody/tr[" + i + "]/td[6]/textarea"))
						.sendKeys("10");
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Batch Size", sno, false);
				Thread.sleep(2000);
				sno++;
				driver.findElement(By.xpath(
						"//*[@id=\"batchesInProtocolEditorTable\"]/div/table/tbody/tr[" + i + "]/td[7]/textarea"))
						.sendKeys("soft sol");
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Customer", sno, false);
			}
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("noOfRowsForAPIInProtForm"))
					.sendKeys(properties.getProperty("NoofProductInformation"));
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Add", sno, false);
			Thread.sleep(3000);
			int noofProductInformation = Integer.parseInt(properties.getProperty("NoofProductInformation"));
			for (int i = 1; i <= noofProductInformation; i++) {
				sno++;
				driver.findElement(
						By.xpath("//*[@id=\"activePharmaIngredientInProtocolEditorTable\"]/div/table/tbody/tr[" + i
								+ "]/td[2]/textarea"))
						.sendKeys("544");
				...
				driver.findElement(
						By.xpath("//*[@id=\"activePharmaIngredientInProtocolEditorTable\"]/div/table/tbody/tr[" + i
								+ "]/td[6]/textarea"))
						.sendKeys("23-11-2020");
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Manufacturer Date", sno,
						false);
				Thread.sleep(2000);
				sno++;
				driver.findElement(
			...
			Thread.sleep(6000);
			sno++;
			driver.findElement(By.id("noOfRowsForPPMInProtForm"))
					.sendKeys(properties.getProperty("NoofProductInformation"));
			...
			if (isRecordSelected2) {
				...
				Thread.sleep(6000);
				sno++;
				driver.findElement(By.id("noOfRowsForSDKTInProtForm"))
						.sendKeys(properties.getProperty("NoofRowsForSampleDetails"));
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter No.of Rows", sno, false);
				Thread.sleep(3000);
				sno++;
				...
				document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Add", sno, false);
				Thread.sleep(2000);
				int NoofRowsForSampleDetails = Integer.parseInt(properties.getProperty("NoofRowsForSampleDetails"));
				for (int i = 1; i <= NoofRowsForSampleDetails; i++) {
					sno++;
					Select storage = new Select(driver.findElement(
							By.xpath("//*[@id=\"sampleDetailsKeptStabilityTableContainer\"]/div/table/tbody/tr[" + i
									+ "]/td[2]/select")));
					Thread.sleep(2000);
					...
					Thread.sleep(2000);
					sno++;
					Select uom = new Select(driver.findElement(
							By.xpath("//*[@id=\"sampleDetailsKeptStabilityTableContainer\"]/div/table/tbody/tr[" + i
									+ "]/td[4]/select")));
					Thread.sleep(2000);
