...
//			Thread.sleep(3000);
			...
			Thread.sleep(5000);
			wait.until(ExpectedConditions.presenceOfElementLocated(
					By.cssSelector("#testGridInStabReqPP_1 > div > div.jtable-busy-message[style='display: none;']")));
			int count11 = 0;
			boolean isRecordSelected11 = false;
			String name11 = properties.getProperty("Test_Name");
			isRecordSelected11 = selectTest(count11, isRecordSelected11, name11);
			sno++;
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select a Record", sno, false);
			Thread.sleep(3000);
			sno++;
	...
	private boolean selectTest(int count11, boolean isRecordSelected11, String name11) throws Exception {
		// TODO Auto-generated method stub
		WebElement table = driver.findElement(By.id("testGridInStabReqPP_1"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"testGridInStabReqPP_1\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//			System.out.println("parts:" + parts.toString());
		...
		if (perPageNoOfRecordsPresent > 0 && count11 == 0) {
			if ((totalNoOfRecords > 1) && ((name11 == null) || ("".equalsIgnoreCase(name11)))) {
				name11 = driver.findElement(By.xpath("//*[@id=\"testGridInStabReqPP_1\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((name11 == null) || ("".equalsIgnoreCase(name11))) {
				name11 = driver.findElement(By.xpath("//*[@id=\"testGridInStabReqPP_1\"]/div/table/tbody/tr/td[3]"))
						.getText();// document
									// type
			}
			++count11;
					...
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver
								.findElement(By.xpath(
										"//*[@id=\"testGridInStabReqPP_1\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
...
//									.click();
							...
							WebElement element8 = driver.findElement(By.xpath(
									"//*[@id=\"testGridInStabReqPP_1\"]/div/table/tbody/tr[" + i + "]/td[4]/input"));
					...
					String DevNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"testGridInStabReqPP_1\"]/div/table/tbody/tr/td[3]"))
							.getText();
					if (name11.equalsIgnoreCase(DevNumberSequence)) {
...
//								.click();
						...
						WebElement element8 = driver.findElement(
								By.xpath("//*[@id=\"testGridInStabReqPP_1\"]/div/table/tbody/tr/td[4]/input"));
						jse8.executeScript("arguments[0].click();", element8);
						isRecordSelected11 = true;
						break;
					}
				...
				if ((!isRecordSelected11) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#testGridInStabReqPP_1 > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("testGridInStabReqPP_1"));// Document Tree approve table
