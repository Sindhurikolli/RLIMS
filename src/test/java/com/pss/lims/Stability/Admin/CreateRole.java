...
public class CreateRole extends com.pss.lims.Satbility.Login.LoginDetails {
	...
	public void createRole() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CreateRole", "LIMS-SM-001", "Pass");
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='createRolesInSM.do'")));
		JavascriptExecutor jse1 = (JavascriptExecutor) driver;
		WebElement element1 = driver.findElement(By.cssSelector("a[href='createRolesInSM.do'"));
	...
	private void createRoleMethod() throws Exception {
		...
		Thread.sleep(5000);
		sno++;
		driver.findElement(By.id("createRoleNameInSM")).sendKeys(properties.getProperty("Role_Name"));
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Role Name", sno, false);
		Thread.sleep(2000);
		sno++;
		driver.findElement(By.id("descriptionForRolesInSM")).sendKeys(properties.getProperty("Role_Description"));
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Role Description", sno, false);
		Thread.sleep(2000);
		sno++;
		driver.findElement(By.id("selBtnInSMRoleForm")).click();
