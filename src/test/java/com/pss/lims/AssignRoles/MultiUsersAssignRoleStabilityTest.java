...
public class MultiUsersAssignRoleStabilityTest {
	...
	public void toMultiUserCreation(String FirstName, String LastName, String RoleName) throws Throwable {
		...
		properties.setProperty("STFirstName", FirstName);
		properties.setProperty("STLastName", LastName);
		properties.setProperty("STRoleName", RoleName);
		properties.save();
		...
		StabilityAssignRoles role = new StabilityAssignRoles();
		role.StabilityAssignRoleMethod();
		LIMSLogin.tearDown();
	...
	public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
		...
		XSSFSheet sh = wb.getSheet("StabilityRole");
