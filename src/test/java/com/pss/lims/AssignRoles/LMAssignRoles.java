...
public class LMAssignRoles extends LIMSLogin {

	@Test
	public void LMAssignRoleMethod() throws Exception {
		...
		Thread.sleep(1000);
		module.selectByVisibleText(properties.getProperty("LM_Module"));
		Thread.sleep(1000);
		...
		WebElement element1 = driver.findElement(By.cssSelector("a[href='createRoleFormInLabelMngmt.do'"));
	...
	private void toCreateUsers() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("a[href='assignRoleFormInLabelMngmt.do'")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("seluserBtnInAssignRolesInLabelMngmt")).click();
		Thread.sleep(5000);
...
//		driver.findElement(By.id("locTreeInCalAssignRoles_2_span")).sendKeys(properties.getProperty("Location_Name"));
		Thread.sleep(5000);
		driver.findElement(By.id("searchFirstName")).sendKeys(properties.getProperty("FirstName"));
		Thread.sleep(1000);
		driver.findElement(By.id("searchLastName")).sendKeys(properties.getProperty("LastName"));
		Thread.sleep(1000);
		...
		if (driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[2]")).isDisplayed()) {
			...
			if (ArrayUtils.contains(arrrolestoselect, RoleName)) {
				Roletoselect.selectByVisibleText(properties.getProperty("RoleName"));
				Thread.sleep(2000);
				JavascriptExecutor jse = (JavascriptExecutor) driver;
				jse.executeScript("window.scrollBy(0,250)");
				Thread.sleep(1000);
				driver.findElement(By.id("submitBtnInLabelMngmtAssignRole")).click();
				Thread.sleep(3000);
