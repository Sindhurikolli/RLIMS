...
public class IMSAssignRoles extends LIMSLogin {

	@Test
	public void IMSAssignRoleMethod() throws Exception {
		...
		Thread.sleep(1000);
		module.selectByVisibleText(properties.getProperty("IM_limsModule"));
		Thread.sleep(1000);
	...
	private void toCreateUsers() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("a[href='assignRoleInIMS.do'")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("seluserBtnInAssignRolesInIms")).click();
		Thread.sleep(5000);
...
//		driver.findElement(By.id("locTreeInCalAssignRoles_2_span")).sendKeys(properties.getProperty("Location_Name"));
		Thread.sleep(5000);
		driver.findElement(By.id("searchFirstName")).sendKeys(properties.getProperty("IM_FirstName"));
		Thread.sleep(1000);
		driver.findElement(By.id("searchLastName")).sendKeys(properties.getProperty("IM_LastName"));
		Thread.sleep(1000);
		...
		if (driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[2]")).isDisplayed()) {
			...
			Thread.sleep(3000);
			String RoleName = properties.getProperty("IM_RoleName");
			...
			if (ArrayUtils.contains(arrrolestoselect, RoleName)) {
				Roletoselect.selectByVisibleText(properties.getProperty("IM_RoleName"));
				Thread.sleep(2000);
				JavascriptExecutor jse = (JavascriptExecutor) driver;
				jse.executeScript("window.scrollBy(0,250)");
				Thread.sleep(1000);
				driver.findElement(By.id("submitBtnInImsAssignRole")).click();
				Thread.sleep(3000);
