...
public class SolutionAssignRoles extends LIMSLogin {

	@Test
	public void SolutionAssignRoleMethod() throws Exception {
		...
		Thread.sleep(1000);
		module.selectByVisibleText(properties.getProperty("Solution_Module"));
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"loginform\"]/div[7]/input")).click();
		Thread.sleep(2000);
		WebDriverWait wait = new WebDriverWait(driver, 200);
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='createRoleFormInSolutionMngmt.do'")));
		JavascriptExecutor jse1 = (JavascriptExecutor) driver;
		WebElement element1 = driver.findElement(By.cssSelector("a[href='createRoleFormInSolutionMngmt.do'"));
	...
	private void toCreateUsers() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("a[href='assignRoleInSolution.do'")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("seluserBtnInAssignRolesInSolMngt")).click();
		Thread.sleep(5000);
...
//		driver.findElement(By.id("locTreeInCalAssignRoles_2_span")).sendKeys(properties.getProperty("Location_Name"));
		Thread.sleep(5000);
		driver.findElement(By.id("searchFirstName")).sendKeys(properties.getProperty("Solution_FirstName"));
		Thread.sleep(1000);
		driver.findElement(By.id("searchLastName")).sendKeys(properties.getProperty("Solution_LastName"));
		Thread.sleep(1000);
		...
		if (driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[2]")).isDisplayed()) {
			...
			Thread.sleep(3000);
			String RoleName = properties.getProperty("Solution_RoleName");
			...
			if (ArrayUtils.contains(arrrolestoselect, RoleName)) {
				Roletoselect.selectByVisibleText(properties.getProperty("Solution_RoleName"));
				Thread.sleep(2000);
				JavascriptExecutor jse = (JavascriptExecutor) driver;
				jse.executeScript("window.scrollBy(0,250)");
				Thread.sleep(1000);
				driver.findElement(By.id("submitBtnInSolMngtAssignRole")).click();
				Thread.sleep(3000);
