...
public class MultiValuesForTestReg {

	static File resultFile = new File("LIMS User Details For Automation.xlsx");
	public static DataFormatter formatter = new DataFormatter();

	@Test(dataProvider = "readExcelFile")
	public void toMultiUserCreation(String variable, String value) throws Throwable {

		Thread.sleep(5000);
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"src\\test\\java\\LIMSUIProperties\\SampleManagement.properties");
		properties.setProperty("Variable_Name", variable);
		properties.setProperty("Symbol", value);
		properties.save();
		...
		login.setUp();
		System.out.println("Role Assigned for - " + value);
		TestReg role = new TestReg();
		role.testReg();
		LIMSLogin.tearDown();
