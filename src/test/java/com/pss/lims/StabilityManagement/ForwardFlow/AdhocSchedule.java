...
//		Thread.sleep(3000);
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
				"#protocolTableInAdhocSchDetails > div > div.jtable-busy-message[style='display: none;']")));
		Thread.sleep(5000);
		int count1 = 0;
		...
		if (isRecordSelected1) {
			...
			Thread.sleep(3000);
			driver.findElement(By.id("scheduleNameInAdhocSchedule")).click();
			Thread.sleep(2000);
			wait.until(ExpectedConditions.presenceOfElementLocated(
					By.cssSelector("#testsTableId > div > div.jtable-busy-message[style='display: none;']")));
			int count = 0;
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("reasonInAdhocSchedule")).sendKeys(properties.getProperty("Description"));
...
//											.click();
							...
							WebElement element8 = driver.findElement(
									By.xpath("//*[@id=\"testsTableId\"]/div/table/tbody/tr[" + i + "]/td[1]/input"));
...
//										.click();
						...
						WebElement element8 = driver
								.findElement(By.xpath("//*[starts-with(@id, \"checkClmInAdhocSchTestSel\")]"));
						jse8.executeScript("arguments[0].click();", element8);
						isRecordSelected = true;
						break;
					}
