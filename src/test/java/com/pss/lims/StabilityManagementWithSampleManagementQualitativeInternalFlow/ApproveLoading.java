	...
	private boolean selectRecordForProtocol(int count, boolean isRecordSelected, String name) throws Exception {
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((name == null) || ("".equalsIgnoreCase(name)))) {
				name = driver
						.findElement(By.xpath("//*[@id=\"loadingApprovalDetailsTable\"]/div/table/tbody/tr[1]/td[5]"))
						.getText();// documentType
			} else if ((name == null) || ("".equalsIgnoreCase(name))) {
				name = driver.findElement(By.xpath("//*[@id=\"loadingApprovalDetailsTable\"]/div/table/tbody/tr/td[5]"))
						.getText();// document
									// type
			}
			++count;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(By.xpath(
								"//*[@id=\"loadingApprovalDetailsTable\"]/div/table/tbody/tr[ " + i + " ]/td[5]"))
					...
					String DevNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"loadingApprovalDetailsTable\"]/div/table/tbody/tr/td[5]"))
							.getText();
					if (name.equalsIgnoreCase(DevNumberSequence)) {
						driver.findElement(
