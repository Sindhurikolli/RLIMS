...
public class CreateRole extends LoginDetails {
	...
	public void createRole() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CreateRole", "LIMS-STM-001", "Pass");
		...
		wait.until(
				ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='createRoleFormInSolutionMngmt.do'")));
	...
	private void createRoleMethod() throws Exception {
		...
		sno++;
		driver.findElement(By.cssSelector("a[href='createRoleFormInSolutionMngmt.do'")).click();
		...
		Thread.sleep(5000);
		sno++;
		driver.findElement(By.id("roleNameInSolMsRoleForm")).sendKeys(properties.getProperty("Role_Name"));
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Role Name", sno, false);
		Thread.sleep(2000);
		sno++;
		driver.findElement(By.id("roleDescriptioncInSolMsRoleForm")).sendKeys(properties.getProperty("Role_Description"));
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Role Description", sno, false);
		Thread.sleep(2000);
		sno++;
		driver.findElement(By.id("selApprFromUserInSolMsRoleForm")).click();
