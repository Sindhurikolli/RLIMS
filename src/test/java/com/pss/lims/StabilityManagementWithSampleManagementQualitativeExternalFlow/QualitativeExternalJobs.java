...
public class QualitativeExternalJobs extends LoginDetails {
	...
	private void methodForExternalJobs() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.id("variableAnsInQualExtJobResult1")).sendKeys(properties.getProperty("FinalValue"));
