...
public class ScheduleReport extends LoginDetails {
	...
	public void scheduleReport() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.id("scheduleReportIms")).click();
		Thread.sleep(5000);
	...
	private void methodForscheduleReport() throws Exception {
		...
		driver.findElement(By.id("srchBtnInScheduleRepSrchIms")).click();
		Thread.sleep(3000);
		int count = 0;
		...
		if (isRecordSelected) {
			...
			WebElement element3 = driver.findElement(By.id("viewRepBtnInScheduleReportIms"));
			...
			Thread.sleep(5000);
			driver.findElement(By.id("saveAsExcelBtnInScheduleRepIms")).click();
			Thread.sleep(7000);
		} else {
	...
	private boolean selectRecordForPrint(int count, boolean isRecordSelected, String record) throws Exception {
		...
		WebElement table = driver.findElement(By.id("scheduleDetailsGridForScheduleReportIms"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(
							By.xpath("//*[@id=\"scheduleDetailsGridForScheduleReportIms\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//						System.out.println("hi this is ravi");
				record = driver
						.findElement(By.xpath(
								"//*[@id=\"scheduleDetailsGridForScheduleReportIms\"]/div/table/tbody/tr[1]/td[4]"))
						.getText();// documentType
			} else if ((record == null) || ("".equalsIgnoreCase(record))) {
				record = driver
						.findElement(By
								.xpath("//*[@id=\"scheduleDetailsGridForScheduleReportIms\"]/div/table/tbody/tr/td[4]"))
						.getText();// document
									// type
			}
			++count;
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(
								By.xpath("//*[@id=\"scheduleDetailsGridForScheduleReportIms\"]/div/table/tbody/tr[ " + i
										+ " ]/td[4]"))
								.getText();// documentTypeName
						if (record.contains(DevNumberSequence)) {
							driver.findElement(
									By.xpath("//*[@id=\"scheduleDetailsGridForScheduleReportIms\"]/div/table/tbody/tr[ "
											+ i + " ]/td[4]"))
									.click();
					...
					String DevNumberSequence = driver
							.findElement(By.xpath(
									"//*[@id=\"scheduleDetailsGridForScheduleReportIms\"]/div/table/tbody/tr/td[4]"))
							.getText();
					if (record.contains(DevNumberSequence)) {
...
////								Thread.sleep(2000);
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#scheduleDetailsGridForScheduleReportIms > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("scheduleDetailsGridForScheduleReportIms"));// Document
					// Tree
					// approve
					// table
