...
public class CalibrationCertificate extends LoginDetails {

	@Test
	public void calibrationCertificate() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.id("calibCertificateReportInIms")).click();
		Thread.sleep(5000);
	...
	private void methodForCalibrationCertificate() throws Exception {
		...
		driver.findElement(By.id("srchBtnInCalibCertifyReport")).click();
		Thread.sleep(3000);
		int count = 0;
		...
		if (isRecordSelected) {
			Thread.sleep(4000);
			driver.findElement(By.id("viewReportBtnInCalibCertifyReport")).click();
			Thread.sleep(10000);
			...
			Thread.sleep(5000);
//			driver.findElement(By.id("printBtnInCalibCertifyReport")).click();
			JavascriptExecutor jse31 = (JavascriptExecutor) driver;
			WebElement element31 = driver.findElement(By.id("printBtnInCalibCertifyReport"));
	...
	private boolean selectRecordForRawDataSheet(int count, boolean isRecordSelected, String name) throws Exception {
		...
		WebElement table = driver.findElement(By.id("calibCertificateReportTable"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"calibCertificateReportTable\"]/div/div[4]/div[2]/span"))
					.getText();// For
			// Ex:
			// Showing
			// 1-1
...
//						System.out.println("hi this is ravi");
				name = driver
						.findElement(By.xpath("//*[@id=\"calibCertificateReportTable\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((name == null) || ("".equalsIgnoreCase(name))) {
				name = driver.findElement(By.xpath("//*[@id=\"calibCertificateReportTable\"]/div/table/tbody/tr/td[3]"))
						.getText();// document
									// type
			}
			++count;
			...
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver.findElement(By.xpath(
								"//*[@id=\"calibCertificateReportTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
					...
					String DevNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"calibCertificateReportTable\"]/div/table/tbody/tr/td[3]"))
							.getText();
					if (name.contains(DevNumberSequence)) {
						driver.findElement(
								By.xpath("//*[@id=\"calibCertificateReportTable\"]/div/table/tbody/tr/td[3]")).click();
						isRecordSelected = true;
						break;
					}
				}
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#calibCertificateReportTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
							.click();// next page in Document approve list
					Thread.sleep(4000);
					table = driver.findElement(By.id("calibCertificateReportTable"));// Document
					// Tree
					// approve
					// table
