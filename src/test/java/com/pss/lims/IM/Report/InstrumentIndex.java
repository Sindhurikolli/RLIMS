...
public class InstrumentIndex extends LoginDetails {

	@Test
	public void instrumentIndex() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.id("instrumentIndexReportInIMS")).click();
		Thread.sleep(5000);
	...
	private void methodForInstrumentIndex() throws Exception {
		...
		driver.findElement(By.id("srchBtnInInstrIndexRepsrch")).click();
		Thread.sleep(3000);
		int count = 0;
		...
		if (isRecordSelected) {
			Thread.sleep(4000);
			driver.findElement(By.id("viewReportBtnInInstrIndexRepsrch")).click();
			Thread.sleep(10000);
...
//			driver.findElement(By.id("saveAsExcelBtnInInstrIndexRepsrch")).click();
	...
	private boolean selectRecordForRawDataSheet(int count, boolean isRecordSelected, String name) throws Exception {
		...
		WebElement table = driver.findElement(By.id("instrmntDtlsGrid"));
		WebElement tableBody = table.findElement(By.tagName("tbody"));
		int perPageNoOfRecordsPresent = tableBody.findElements(By.tagName("tr")).size();
		int totalNoOfRecords = 0;
		int noOfRecordsChecked = 0;
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"instrmntDtlsGrid\"]/div/div[4]/div[2]/span")).getText();// For
			// Ex:
			// Showing
			// 1-1
			// of
...
//						System.out.println("hi this is ravi");
				name = driver.findElement(By.xpath("//*[@id=\"instrmntDtlsGrid\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((name == null) || ("".equalsIgnoreCase(name))) {
				name = driver.findElement(By.xpath("//*[@id=\"instrmntDtlsGrid\"]/div/table/tbody/tr/td[3]")).getText();// document
																														// type
			}
			++count;
		}
		if (perPageNoOfRecordsPresent > 0) {
			while (noOfRecordsChecked < totalNoOfRecords) {
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String DevNumberSequence = driver
								.findElement(
										By.xpath("//*[@id=\"instrmntDtlsGrid\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
					...
					String DevNumberSequence = driver
							.findElement(By.xpath("//*[@id=\"instrmntDtlsGrid\"]/div/table/tbody/tr/td[3]")).getText();
					if (name.contains(DevNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"instrmntDtlsGrid\"]/div/table/tbody/tr/td[3]")).click();
						isRecordSelected = true;
						break;
					}
				}
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					...
					Thread.sleep(4000);
					table = driver.findElement(By.id("instrmntDtlsGrid"));// Document
					// Tree
					// approve
					// table
