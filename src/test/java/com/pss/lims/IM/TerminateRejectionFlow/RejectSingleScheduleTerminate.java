...
public class RejectSingleScheduleTerminate extends LoginDetails {

	@Test
	public void rejectSingleScheduleTerminate() throws Exception {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Terminate Single Schedule Reject", "LIMS-IMS-035",
				"Pass");
		...
		Thread.sleep(4000);
		methodTorejectSingleScheduleTerminate();
		document.close();
		writer.close();
	...
	private void methodTorejectSingleScheduleTerminate() throws Exception {
