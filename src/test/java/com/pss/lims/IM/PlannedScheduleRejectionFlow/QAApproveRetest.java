...
public class QAApproveRetest extends LoginDetails {

	@Test
	public void retestQA() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ReTestQAApprove" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ReTest QA Approve", "PSS-LIMS-029", "Pass");
		...
		WebElement element1 = driver.findElement(By.xpath("//*[@id=\"imResultReviewSectionBody\"]/a[5]"));
...
//			Thread.sleep(5000);
			...
			WebElement element11 = driver.findElement(By.id("reTestActionInQAApproveResultId"));
			jse11.executeScript("arguments[0].scrollIntoView(true);", element11);
			Thread.sleep(2000);
			sno++;
			JavascriptExecutor jse31 = (JavascriptExecutor) driver;
			WebElement element31 = driver.findElement(By.id("reTestActionInQAApproveResultId"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			while (noOfRecordsChecked < totalNoOfRecords) {
				...
				if ((!isRecordSelected) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#imsQAApproveOfScheduleResultsForm > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next.jtable-page-number-disabled"))
