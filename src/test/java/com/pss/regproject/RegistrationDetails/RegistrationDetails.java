package com.pss.regproject.RegistrationDetails;
...
public class RegistrationDetails  {
	...
	public void setUp() throws Exception {
	    ...
	    propertyFilePathName = propertiesFilePath; 	
			...
			propertyFilePathName ="src\\test\\java\\LIMSUIProperties\\Registration.properties";	
		}
		...
		if ((url != null) && (browserName != null) && (loginUserName != null) && (loginUserPassword != null)
            ...
            driver.get(properties.getProperty("REGISTRATIONLoginUrl"));
            driver.manage().window().maximize();          
		}
